...
import com.zy.pojo.vo.PaymentInfoVO;
import com.zy.resource.AliPayResource;
import com.zy.resource.WXPayResource;
import com.zy.service.PaymentOrderService;
import com.zy.utils.CurrencyUtils;
import com.zy.utils.IMOOCJSONResult;
import com.zy.utils.RedisOperator;
import com.zy.wx.entity.PreOrderResult;
import com.zy.wx.service.WxOrderService;
...
public class PaymentController {
    ...
    public IMOOCJSONResult createMerchantOrder(@RequestBody MerchantOrdersBO merchantOrdersBO, HttpServletRequest request, HttpServletResponse response) {
        ...
        // 保存传来的商户订单信息
        try {
            boolean isSuccess = paymentOrderService.createPaymentOrder(merchantOrdersBO);
            if (isSuccess) {
    ...
    public IMOOCJSONResult getWXPayQRCode(String merchantOrderId, String merchantUserId) {
...
//				String total_fee = "1";	// 测试用 1分钱
    ...
    public IMOOCJSONResult goAlipay(String merchantOrderId, String merchantUserId) {
        try {
            // 查询订单详情
            PayOrders waitPayOrder = paymentOrderService.queryOrderByStatus(merchantUserId, merchantOrderId, PaymentStatus.WAIT_PAY.type);
